...
class Landscape:
    ...
    def marginal_entropy(self, base=2):
        r"""
    ...
    def conditional_entropy(self, base=2):
        ...
        H: float
            The joint entropy of the class adjacencies
        """
        return self.joint_entropy(base=base) - self.marginal_entropy(base=base)
    ...
    def mutual_information(self, base=2):
        ...
        H: float
            The joint entropy of the class adjacencies
        """
        return self.marginal_entropy(base=base) - self.conditional_entropy(base=base)
